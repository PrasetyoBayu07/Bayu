...
module.exports = aqla = async (aqla, mek) => {
  try {
    ...
    let ftroli = {
      ...
      message: { orderMessage: { itemCount: 2021, status: 200, thumbnail: thumbnail, surface: 200, message: `${botname} 🏟️\nBy ${ownername}`, orderTitle: "aqlabriyan", sellerJid: "0@s.whatsapp.net" } },
      sendEphemeral: true,
    };
    ...
    let fgif = {
      key: { participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "6289643739077-1613049930@g.us" } : {}) },
      message: { videoMessage: { title: `© ${ownername}`, h: `Hmm`, seconds: "99999", gifPlayback: "true", caption: `${botname} 🏟️\nBy ${ownername}`, jpegThumbnail: thumbnail } },
    };
    let fgclink = {
      key: { participant: "0@s.whatsapp.net", remoteJid: "0@s.whatsapp.net" },
      message: { groupInviteMessage: { groupJid: "6288213840883-1616169743@g.us", inviteCode: "m", groupName: "P", caption: `© ${botname}`, jpegThumbnail: thumbnail } },
    };
    let fgclink2 = {
      key: { participant: "0@s.whatsapp.net", remoteJid: "0@s.whatsapp.net" },
      message: { groupInviteMessage: { groupJid: "6288213840883-1616169743@g.us", inviteCode: "m", groupName: "P", caption: `© ${botname}`, jpegThumbnail: thumbnail } },
    ...
    let fvideo = {
      key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "6289643739077-1613049930@g.us" } : {}) },
      message: { videoMessage: { title: `© ${ownername}`, h: `Hmm`, seconds: "99999", caption: `© ${ownername}`, jpegThumbnail: thumbnail } },
    };
    let floc = {
      contextInfo: {
        forwardingScore: 999,
        ...
        quotedMessage: { locationMessage: { degreesLatitude: 41.893714904785156, degreesLongitude: -87.63370513916016, name: botname, jpegThumbnail: thumbnail } },
      },
    };
    let fkontak = {
      key: { participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: `6283136505591-1614953337@g.us` } : {}) },
      message: {
        contactMessage: {
    ...
    switch (command) {
      ...
      case "help":
      case "aqla":
        if (!isAqla) return sendButMessage(from, lang.noregis(pushname), `Klik Button Untuk Verify`, [{ buttonId: ".daftar", buttonText: { displayText: `Daftar` }, type: 1 }], { quoted: fgif });
        sendButLocation(
          from,
      ...
      case "s":
        ...
        if (((isMedia && !mek.message.videoMessage) || isQuotedImage) && args.length == 0) {
          ...
          const media = await aqla.downloadAndSaveMediaMessage(encmedia);
          ran = getRandom(".webp");
          await ffmpeg(`./${media}`)
            .input(media)
            ...
            .on("end", function () {
              console.log("Finish");
              aqla.sendMessage(from, fs.readFileSync(ran), sticker, { quoted: mek });
              fs.unlinkSync(media);
              fs.unlinkSync(ran);
            })
            .addOutputOptions([
          ...
          .then(async (result) => {
            for (let i of result.medias) {
              if (i.url.includes("mp4")) {
                ...
                aqla.sendMessage(from, link, video, { thumbnail: Buffer.alloc(0), quoted: mek, caption: `Instagram •  ${i.type}` });
              } else {
                let link = await getBuffer(i.url);
                aqla.sendMessage(from, link, image, { thumbnail: Buffer.alloc(0), quoted: mek, caption: `Instagram • ${i.type}` });
              }
            }
          })
      ...
      case "tiktok":
        ...
        sendButLocation(
          from,
          "Silahkan pilih media yang ingin kamu download",
          "© " + ownername,
          thumbnail,
          [
            { buttonId: `.tiktokwm ${q}`, buttonText: { displayText: "WM" }, type: 1 },
            { buttonId: `.tiktoknowm ${q}`, buttonText: { displayText: "NOWM" }, type: 1 },
      ...
      case "tiktoknowm":
        ...
        qla
          ...
          .then((result) => {
            ...
            axios.get(`https://tinyurl.com/api-create.php?url=${nowm}`).then(async (a) => {
              me = `*Link* : ${a.data}`;
              noweem = await getBuffer(nowm);
              aqla.sendMessage(from, noweem, MessageType.video, { mimetype: "video/mp4", quoted: mek });
            });
          })
        ...
        qla
          ...
          .then((result) => {
            ...
            axios.get(`https://tinyurl.com/api-create.php?url=${nowm}`).then(async (a) => {
              ...
              aqla.sendMessage(from, weem, MessageType.video, { mimetype: "video/mp4", quoted: mek });
            });
          })
          .catch((err) => reply(`Link tidak valid`));
      ...
      case "tiktokaudio":
        ...
        qla
          ...
          .then((result) => {
            const { wm, nowm, audio } = result;
            axios.get(`https://tinyurl.com/api-create.php?url=${audio}`).then(async (a) => {
              audnha = await getBuffer(audio);
              aqla.sendMessage(from, audnha, MessageType.document, { mimetype: "audio/mp4", filename: `Tiktok Music.mp3`, quoted: mek });
            });
          })
          .catch((err) => reply(`Link tidak valid`));
      ...
      case "song":
        ...
        try {
          qla.Youtube(mulaikah).then(async (data) => {
...
• Url : ${aramas.videos[0].url}`;
            ...
            sendButLocation(
              ...
              thumbyt,
              [
                { buttonId: `.ytmp4 ${mulaikah}`, buttonText: { displayText: "Video" }, type: 1 },
                { buttonId: `.ytmp3 ${mulaikah}`, buttonText: { displayText: "Audio" }, type: 1 },
              ],
              { quoted: mek }
            );
          });
      ...
      case "spotify":
        {
          ...
          await aqla.sendMessage(from, thumbnail, image, { quoted: lol, caption: ini_txt });
          get_audio = await getBuffer(get_result.link);
          await aqla.sendMessage(from, get_audio, audio, { mimetype: "audio/mpeg", filename: `${get_result.title}.mp3`, quoted: mek });
        }
        break;
      case "spotifysearch":
        {
      ...
      case "nhentaipdf":
        {
          ...
          await aqla.sendMessage(from, ini_buffer, document, { quoted: mek, mimetype: Mimetype.pdf, filename: `${henid}.pdf` });
        }
        break;
      case "nhentaisearch":
        {
      ...
      case "freefire":
        {
          if (!isAqla) return sendButMessage(from, lang.noregis(pushname), `Klik Button Untuk Verify`, [{ buttonId: ".daftar", buttonText: { displayText: `Daftar` }, type: 1 }], { quoted: fgif });
          if (args.length == 0) return reply(`Example: ${prefix + command} aqla`);
          ini_txt = args.join(" ");
          var po = await getBuffer(`https://api.lolhuman.xyz/api/ephoto1/${command}?apikey=${lolkey}&text=${ini_txt}`);
          aqla.sendMessage(from, po, image, { quoted: mek, caption: "Selesai" });
        }
        break;
      //maker textpro
      case "blackpink":
      ...
      case "thunder":
        {
          ...
          aqla.sendMessage(from, gambar, image, { quoted: mek, caption: "Sukses" });
        }
        break;
      //islami
      case "listsurah":
      ...
      case "alquranaudio":
        {
          ...
          await aqla.sendMessage(from, ini_buffer, audio, { quoted: mek, mimetype: "audio/mpeg" });
        }
        break;
      case "jadwalsholat":
        {
      ...
      case "verify":
      case "verif":
        if (isAqla) return reply(lang.regis());
        try {
          ppregis = await aqla.getProfilePicture(sender);
        } catch {
      ...
      case "memegen":
        {
          ...
          try {
            ...
            var mediiia = await aqla.downloadMediaMessage(enmedia);
            ...
            aqla.sendMessage(from, resu, image, { caption: ".stikerin bang", thumbnail: Buffer.alloc(0), quoted: mek });
      ...
      case "smeme":
        {
          ...
          try {
            ...
            var teks2 = args.join(" ");
            var enmedia = isQuotedImage ? JSON.parse(JSON.stringify(mek).replace("quotedM", "m")).message.extendedTextMessage.contextInfo : mek;
            var mediia = await aqla.downloadMediaMessage(enmedia);
      ...
      case "leave":
        ...
        setTimeout(() => {
          aqla.groupLeave(from);
        }, 2000);
        setTimeout(() => {
          aqla.sendMessage(from, "Sayonara👋", text);
        }, 0);
        break;
      case "hidetag":
        if (!isAqla) return sendButMessage(from, lang.noregis(pushname), `Klik Button Untuk Verify`, [{ buttonId: ".daftar", buttonText: { displayText: `Daftar` }, type: 1 }], { quoted: fgif });
        ...
        if (!isGroupAdmins) return reply(lang.admin(groupName));
        var value = q;
        var group = await aqla.groupMetadata(from);
        ...
        aqla.sendMessage(from, options, text);
        break;
      case "linkgrup":
      case "linkgroup":
      case "linkgc":
        if (!isAqla) return sendButMessage(from, lang.noregis(pushname), `Klik Button Untuk Verify`, [{ buttonId: ".daftar", buttonText: { displayText: `Daftar` }, type: 1 }], { quoted: fgif });
        if (!isGroup) return reply(lang.group());
        linkgc = await aqla.groupInviteCode(from);
        yeh = `https://chat.whatsapp.com/${linkgc}\n\nlink Group *${groupName}*`;
        aqla.sendMessage(from, yeh, text, { quoted: mek });
        break;
      case "tagall":
        if (!isAqla) return sendButMessage(from, lang.noregis(pushname), `Klik Button Untuk Verify`, [{ buttonId: ".daftar", buttonText: { displayText: `Daftar` }, type: 1 }], { quoted: fgif });
        if (!isGroup) return reply(lang.group());
      ...
      case "setname":
        ...
        if (!isGroupAdmins) return reply(lang.admin(groupName));
        if (!isBotGroupAdmins) return reply(lang.adminB());
        await aqla.groupUpdateSubject(from, `${q}`);
        aqla.sendMessage(from, `Sukses Mengubah Nama Grup Menjadi ${q}`, text, { quoted: mek });
        break;
      case "setdesc":
      case "setdesk":
        if (!isAqla) return sendButMessage(from, lang.noregis(pushname), `Klik Button Untuk Verify`, [{ buttonId: ".daftar", buttonText: { displayText: `Daftar` }, type: 1 }], { quoted: fgif });
        ...
        if (!isGroupAdmins) return reply(lang.admin(groupName));
        if (!isBotGroupAdmins) return reply(lang.adminB());
        await aqla.groupUpdateDescription(from, `${q}`);
        aqla.sendMessage(from, `Sukses Mengubah Desk Grup Menjadi ${q}`, text, { quoted: mek });
        break;
      case "kick":
        if (!isAqla) return sendButMessage(from, lang.noregis(pushname), `Klik Button Untuk Verify`, [{ buttonId: ".daftar", buttonText: { displayText: `Daftar` }, type: 1 }], { quoted: fgif });
        if (!isGroup) return reply(lang.group());
        ...
        await aqla.groupRemove(from, [kickya]);
      ...
      case "broadcast":
        ...
        var bcnya = await aqla.chats.all();
        if ((isMedia && !mek.message.videoMessage) || isQuotedImage) {
          ...
          var bcnya3 = await aqla.downloadMediaMessage(bcnya2);
          for (let _ of bcnya) {
            aqla.sendMessage(_.jid, bcnya3, image, { caption: `*----「  BROADCAST 」----*\n\n${q}` });
          }
      ...
      case "nightcore":
        {
          ...
          media = await aqla.downloadAndSaveMediaMessage(encmedia);
          ran = getRandom(".mp3");
          exec(`ffmpeg -i ${media} -filter:a atempo=1.06,asetrate=44100*1.25 ${ran}`, (err, stderr, stdout) => {
            fs.unlinkSync(media);
            if (err) return reply("Error!");
            hah = fs.readFileSync(ran);
            aqla.sendMessage(from, hah, audio, { mimetype: "audio/mp4", ptt: true, quoted: mek, duration: 99999999999999999999999 });
            fs.unlinkSync(ran);
          });
        }
        break;
      ...
      case "slow":
        {
          try {
            ...
            exec(`ffmpeg -i ${media} -filter:a "atempo=0.7,asetrate=44100" ${ran}`, (err, stderr, stdout) => {
              ...
              aqla.sendMessage(from, uhh, audio, { mimetype: "audio/mp4", ptt: true, quoted: mek });
              fs.unlinkSync(ran);
            });
          } catch (e) {
            reply("Error!");
      ...
      case "robot":
        {
          ...
          exec(`ffmpeg -i ${media} -filter_complex "afftfilt=real='hypot(re,im)*sin(0)':imag='hypot(re,im)*cos(0)':win_size=512:overlap=0.75" ${ran}`, (err, stderr, stdout) => {
            ...
            if (err) return reply("Error!");
            hah = fs.readFileSync(ran);
            aqla.sendMessage(from, hah, audio, { mimetype: "audio/mp4", ptt: true, quoted: mek });
            fs.unlinkSync(ran);
          });
        }
        break;
      ...
      case "tupai":
        {
          try {
            ...
            exec(`ffmpeg -i ${media} -filter:a "atempo=0.5,asetrate=65100" ${ran}`, (err, stderr, stdout) => {
              ...
              if (err) return reply("Error!");
              hah = fs.readFileSync(ran);
              aqla.sendMessage(from, hah, audio, { mimetype: "audio/mp4", ptt: true, quoted: mek, duration: 999099 });
              fs.unlinkSync(ran);
            });
          } catch (e) {
            reply(mess.error);
      ...
      case "toimg":
        {
          ...
          mediaa = await aqla.downloadAndSaveMediaMessage(encmediaa);
          ran = getRandom(".png");
          exec(`ffmpeg -i ${mediaa} ${ran}`, (err) => {
            fs.unlinkSync(mediaa);
            if (err) return reply("Eror");
            buffer = fs.readFileSync(ran);
            aqla.sendMessage(from, buffer, image, { quoted: mek, thumbnail: Buffer.alloc(0), caption: "Done" });
            fs.unlinkSync(ran);
          });
        }
        break;
      case "nuliskiri":
        {
          ...
          spawn("convert", [
            ...
            .on("exit", () => {
              aqla.sendMessage(from, fs.readFileSync("./database/media/nulis/images/buku/setelahkiri.jpg"), image, { thumbnail: Buffer.alloc(0), quoted: mek, caption: `Hati-hati ketahuan!` });
            });
        }
        break;
      case "nuliskanan":
        {
          ...
          spawn("convert", [
            ...
            .on("error", () => reply(mess.error))
            .on("exit", () => {
              aqla.sendMessage(from, fs.readFileSync("./database/media/nulis/images/buku/setelahkanan.jpg"), image, { thumbnail: Buffer.alloc(0), quoted: mek, caption: `Hati-hati ketahuan!` });
            });
        }
        break;
      case "foliokiri":
        {
          ...
          spawn("convert", [
            ...
            .on("error", () => reply(mess.error))
            .on("exit", () => {
              aqla.sendMessage(from, fs.readFileSync("./database/media/nulis/images/folio/setelahkiri.jpg"), image, { thumbnail: Buffer.alloc(0), quoted: mek, caption: `Hati-hati ketahuan!` });
            });
        }
        break;
      case "foliokanan":
        {
          ...
          spawn("convert", [
            ...
            .on("error", () => reply(mess.error))
            .on("exit", () => {
              aqla.sendMessage(from, fs.readFileSync("./database/media/nulis/images/folio/setelahkanan.jpg"), image, { thumbnail: Buffer.alloc(0), quoted: mek, caption: `Hati-hati ketahuan!` });
            });
        }
        break;
      case "facebook":
      ...
      case "facebookdl":
        {
          ...
          try {
            qla.Facebook(`${q}`).then(async (data) => {
              ...
              aqla.sendMessage(from, ppfb, video, { mimetype: "video/mp4", quoted: mek, caption: txt });
            });
          } catch {
      ...
      case "soundcloud":
        ...
        await reply(lang.wait());
        qla.SoundCloud(`${q}`).then(async (data) => {
          ...
          aqla.sendMessage(from, await getBuffer(data.medias[0].url), audio, { quoted: mek, mimetype: "audio/mp4" });
        });
        break;
      case "telesticker":
      case "tstiker":
        {
          ...
          var telestc = await qla.Telesticker(`${q}`);
          await reply(lang.wait());
          for (let i = 0; i < (telestc.length < 10 ? telestc.length : 10); i++) {
            aqla.sendMessage(from, await getBuffer(telestc[i].url), sticker, { mimetype: "image/webp", quoted: mek });
          }
        }
        break;
      case "tebakgambar":
        ...
        hx.tebakgambar().then(async (data) => {
          ...
          fs.writeFileSync("./database/game/tebakgambar.json", JSON.stringify(tebakgambar));
          console.log(jawaban);
          aqla.sendMessage(from, tebakya, image, { quoted: mek, caption: "\n\nTimeout : 120.00 seconds" });
          await sleep(120000);
          if (tebakgambar.hasOwnProperty(sender.split("@")[0])) {
            aqla.sendMessage(from, "Waktu permainan habis" + "\n\n" + "*Jawaban :*" + "\n" + "_" + jawaban + "_", text, { quoted: mek }); // ur cods
            delete tebakgambar[sender.split("@")[0]];
            fs.writeFileSync("./database/game/tebakgambar.json", JSON.stringify(tebakgambar));
          }
        });
      ...
      case "emoji":
        ...
        emoji.get(`${qes}`).then(async (emojii) => {
          ...
          console.log(teks);
          //aqla.sendMessage(from, await getBuffer(teks), sticker, {mimetype:'image/webp',quoted: mek})
